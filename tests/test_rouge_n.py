...
class RougeNTest(TestCase):
    ...
    def test_apply_avg(self):
        ...
        apply_avg = True
        apply_best = False
        all_asserts = run_a_single_t_est_on_all_files_rouge_n(self.metrics, self.N, alpha, apply_avg, apply_best, length_limit, length_limit_type, limit_length, self.rouge_dir, stemming, self.epsilon_ngrams_count_and_hits, self.epsilon_avg_with_resampling)
